...
class PrepareSQLFromTabularData:
    ...
    """
    def __init__(self, files_dir:str, sqldb_directory:str) -> None:
        """
        ...
        Args:
            ...
            sqldb_directory (str): The directory where the SQLite database will be created.
        """
       
        self.files_directory = files_dir
        self.file_dir_list = os.listdir(files_dir)
        db_path = sqldb_directory
    ...
    def _prepare_db(self):
        ...
        print("==============================")
        print("All files are saved into the sql database.")
